<template>
  <div class="user-box">
    ...
    <div class="box-balance">
      ...
      <span><van-icon name="gold-coin-o" size="25" />
        <p>充值</p>
      </span>
    </div>
    ...
    <div class="box-orders1">
      ...
      <div v-if="isBottom1Visible" class="orders-bottom orders-bottom1">
        <span @click="() => { router.push('/campus/user/my-parttime/posted'); }">15<br>
          <p>我的发布</p>
        </span>
        <span @click="() => { router.push('/campus/user/my-parttime/MyApplied'); }">18<br>
          <p>我的申请</p>
        </span>
        <!--  <span>8<br>
          <p>执行中</p>
    ...
    <div class="box-function">
      <span><van-icon name="clock-o" size="20" /><br>
        <p>浏览历史</p>
      </span>
      <span><van-icon name="notes-o" size="20" /><br>
        <p>我的帖子</p>
      </span>
      <span><van-icon name="like-o" size="20" @click="toCollect" /><br>
        <p>收藏夹</p>
      </span>
      <RouterLink to="user/detail">
        <span><van-icon name="envelop-o" size="20" />
          <p>个人资料</p>
        </span>
      </RouterLink>
    </div>
