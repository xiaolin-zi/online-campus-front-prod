...
import { searchMyActiveListApi, searchMyAppliedListApi, searchMyFinishedListApi } from '@/apis/parttime/index'
...
const ActiveList = reactive<activeListRecords|any>([]);
const goBack = () => {
  router.go(-1);
...
const FinishedList = reactive<FinishedListRecords|any>([]);
...
const Applied = reactive<AppliedListRecords|any>([]);
const getDataAll = async () => {
  let result = await searchMyAppliedListApi();
  //console.log(result.data.data)
  console.log(result)
